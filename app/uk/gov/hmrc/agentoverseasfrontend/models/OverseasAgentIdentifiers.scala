...
object CtAgentCode {
  ...
  implicit val writes: SimpleObjectWrites[CtAgentCode] =
    new SimpleObjectWrites[CtAgentCode](_.value)
}
...
object ApplicationReference {
  ...
  implicit val writes: SimpleObjectWrites[ApplicationReference] =
    new SimpleObjectWrites[ApplicationReference](_.value)
