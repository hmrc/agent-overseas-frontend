...
import uk.gov.hmrc.agentoverseasfrontend.support.{BaseISpec, WireMockSupport}
...
class AgentOverseasApplicationConnectorISpec
    ...
    with AuthStubs with DataStreamStubs {
  ...
  private lazy val connector: AgentOverseasApplicationConnector =
    new AgentOverseasApplicationConnector(appConfig, http)
